<html>
	...
	<body>
		...
		<?php			
			...
			if (isset($_GET['operation']) && isset($_GET['value1']) && is_numeric($_GET['value1']) && ($_GET['value1'])>0 && isset($_GET['value2']) && is_numeric($_GET['value2']) && ($_GET['value2'])>0 && isset($_GET['value3']) && is_numeric($_GET['value3']) && ($_GET['value3'])>0){	
